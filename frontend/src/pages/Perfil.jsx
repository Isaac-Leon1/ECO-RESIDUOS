        ...
        <div className="lg:w-[80%] md:w-[90%] xs:w-[96%] mx-auto flex gap-4">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="aspect-[28/1]">
                    <h2 className={`text-grey text-center text-sm pt-2  ${onEdit ? '' : 'hidden'}`}>Ahora puedes editar tu perfil!</h2>
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    <div className={`w-full rounded-lg bg-blue-500 mt-4 hover:bg-blue-400 text-white text-lg font-semibold ${onEdit ? 'hidden' :''}`}>
                    <button onClick={()=> setOnEdit(true)} type="button" className="w-full p-4">
                        Editar Perfil
                    </button>
                    </div>
                    <div className={`w-full rounded-lg bg-blue-500 mt-4 hover:bg-blue-400 text-white text-lg font-semibold ${onEdit ? '' :'hidden'}`}>
