...
const RecuperarContrasenaAdministrador = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-[40%] flex justify-center">
        ...
        >
        <h1 className="text-[#06457C] text-[36px] font-bold text-center">Recuperar contraseña</h1>
          ...
          <p className="text-[14px] text-center">
            ¿No tienes cuenta?{" "}
            <a href="/administrador/registro" className="text-[#0464B8]">
              {" "}
              Registrate aquí
            </a>
          </p>
...
export default RecuperarContrasenaAdministrador;
