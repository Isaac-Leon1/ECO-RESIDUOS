      ...
      <div className="min-h-screen w-[40%] flex justify-center">
        ...
        >
          ...
          <div className="relative">
            ...
            />
            {mostrarPassword ? ( 
              <svg onClick={() => setMostrarPassword(false)}
              ...
              <svg onClick={() => setMostrarPassword(true)}
                className="absolute inset-y-0 right-5 h-full cursor-pointer"
                xmlns="http://www.w3.org/2000/svg"
                width="19"
                height="13"
          ...
          <a href="/administrador/recuperarcontrasena" className="text-[#0464B8] text-[14px] text-center">¿Olvidó la contraseña?</a>
...
export default IniciarSesionAdministrador;
